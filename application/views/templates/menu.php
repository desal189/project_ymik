            ...
            <div class="nav">
                ...
                <div class="collapse" id="master" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="<?= base_url('master/dataTahunan') ?>">Master Tahunan</a>
                        <a class="nav-link" href="<?= base_url('master/siswa') ?>">Master Siswa</a>
                        <a class="nav-link" href="layout-sidenav-light.html">Master Keuangan</a>
                    </nav>
                </div>
